...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Mapumba Mark NTUMBA <marmap4@gmail.com>");
...
struct miscdevice mntumba_device = {
    .name = "fortytwo",
...
static int __init entry_point(void)
{
	...
	return misc_register(&mntumba_device);
}

static void __exit exit_point(void)
{
	printk(KERN_INFO "Cleaning up module.\n");
	misc_deregister(&mntumba_device);
}
